...
TRAINING_CONFIG = {
    ...
    "per_device_train_batch_size": 2,    # Server has 48GB VRAM, can use 2 (same as MTUP)
    "gradient_accumulation_steps": 8,    # Same as MTUP to keep effective batch = 16
    ...
    "fp16": False,                       # CRITICAL: FP16 causes NaN loss with gradient checkpointing
    "bf16": True,                        # Use BF16 instead - more stable with gradient checkpointing
